...
def baseline_network(images, dropout, mode):
    ...
    with tf.variable_scope('Baseline_FC_network'):
        ...
        # FC--1
        layer_9 = tf.contrib.layers.fully_connected(layer_8, 3072,
                             activation_fn=None, scope='layer_9')
        ...
        # FC-2
        layer_10 = tf.contrib.layers.fully_connected(layer_9, 3072,
                             activation_fn=None,  scope='layer_10')
        layer_10 = _batch_norm(layer_10, mode=mode, name='layer_10')
        layer_10 = tf.nn.leaky_relu(layer_10,  name='relu_layer_10')
        layer_10 = tf.nn.dropout(layer_10, keep_prob=dropout)
