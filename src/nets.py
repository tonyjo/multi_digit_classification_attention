...
def classification_network(images, dropout, mode='train'):
    with tf.variable_scope('classification_CNN'):
        ...
        layer_5 = slim.conv2d(layer_4, 196, [5, 5],
                            activation_fn=None,
                            padding='VALID',
                            weights_initializer=tf.contrib.layers.variance_scaling_initializer(mode='FAN_IN'),
        ...
        layer_6 = slim.conv2d(layer_5, 196, [3, 3],
                            activation_fn=None,
                            padding='SAME',
                            weights_initializer=tf.contrib.layers.variance_scaling_initializer(mode='FAN_IN'),
        ...
        layer_7 = slim.conv2d(layer_6, 196, [3, 3],
                            activation_fn=None,
                            padding='VALID',
                            weights_initializer=tf.contrib.layers.variance_scaling_initializer(mode='FAN_IN'),
        ...
        layer_8 = slim.conv2d(layer_7, 196, [3, 3],
                            activation_fn=None,
                            padding='VALID',
                            weights_initializer=tf.contrib.layers.variance_scaling_initializer(mode='FAN_IN'),
    ...
    with tf.variable_scope('classification_Fully_Connected'):
        ...
        layer_9 = tf.contrib.layers.fully_connected(layer_8, 128,
                                                    activation_fn=None)
        layer_9 = _batch_norm(layer_8, mode=mode, name='layer_9')
        layer_9 = tf.nn.leaky_relu(layer_9, name='relu_layer_9')
        layer_9 = tf.nn.dropout(layer_9, keep_prob=dropout)
        # Classification layer
        layer_10 = tf.contrib.layers.fully_connected(layer_9, 10,
                                                    activation_fn=None)
